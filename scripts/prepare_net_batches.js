...
async function main() {
  ...
  console.log(`Found ${allNet.length} Networking questions in database.`);
  ...
  fs.writeFileSync('scripts/net_raw_questions.json', JSON.stringify(allNet, null, 2));
  console.log("Saved raw questions to scripts/net_raw_questions.json");
}
